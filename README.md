...
## 📈 Executive Dashboard
*(Note: Replace the line below with the actual screenshot of your Power BI dashboard)*
![Power BI Executive Dashboard](link-to-your-power-bi-screenshot.png)

## 💡 The Business Problem
Macro-level reporting often hides micro-level bleeding. A campaign might look profitable on a monthly basis but lose thousands of dollars under specific conditions. This project audits cross-platform daily performance across **Google Ads, Meta Ads, and TikTok Ads** to uncover these hidden daily inefficiencies.

## 🎯 Risk Management & Key Findings
Macro-level reporting often hides micro-level bleeding. To uncover hidden daily inefficiencies across Google Ads, Meta Ads, and TikTok Ads, this project quantified variance and risk at a granular level:
